...
// .wrangler/tmp/pages-zA3D53/functionsWorker-0.7224767381844039.mjs
...
var onRequestGet = /* @__PURE__ */ __name2(async (context22) => {
  ...
  const apiKey = url.searchParams.get("apiKey") || context22.env.PAGESPEED_API_KEY;
  if (!targetUrl) {
...
var onRequestGet2 = /* @__PURE__ */ __name2(async (context22) => {
  ...
  try {
    ...
    return new Response(JSON.stringify({ error: `Failed to fetch: ${error32.message}` }), {
      status: 500,
      headers: { "Content-Type": "application/json" }
    });
  }
...
// .wrangler/tmp/bundle-xExZt1/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-xExZt1/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.7224767381844039.js.map

...
const PageSpeedInsights = () => {
  ...
  const startAnalysis = async () => {
    ...
    if (!apiKey) {
      toast.error('Please enter your PageSpeed API Key');
      return;
    }
      ...
      <div className="bg-card p-6 rounded-xl border shadow-sm space-y-6">
        ...
        <div className="space-y-2">
          <label className="text-sm font-bold flex items-center gap-2">
            <Key className="h-4 w-4 text-primary" /> Your PageSpeed API Key
          </label>
          ...
          <p className="text-[10px] text-muted-foreground">
            Don't have one? Get it for free from the <a href="https://developers.google.com/speed/docs/insights/v5/get-started" target="_blank" rel="noreferrer" className="text-primary underline">Google Cloud Console</a>. Key is saved locally in your browser.
          </p>
        </div>
